...
| 本文件状态 | **草案 v0.1（2026-09-16）**——待 HO 采纳为工作单后生效；本文不代表任何完成度 |
...
1. **HO 采纳本合同与本文**：在 `DEMO-1-contract-v1.0.md` 登记本里补一行采纳记录（日期 + 依据），本文随之从「草案 v0.1」升为「生效」——**这是 S0 的唯一未闭环项**，不采纳则 §4 的切片顺序不生效。
